...
public class ClientDemo {
    public static void main(String[] args) {
        try {
            ...
            //加报
            String messtr="7E 7E 01 60 60 00 15 01 12 34 33 00 25 02 00 1C 22 07 13 16 05 42 F1 F1 60 60 00 15 01 4B F0 F0 22 07 13 16 05 26 19 00 15 14 20 19 00 00 46 38 12 12 13 03 10 DD";
